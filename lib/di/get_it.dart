...
Future init() async {
  ...
  getItInstance.registerFactory<VerifyNeededCubit>(
      () => VerifyNeededCubit(getVerifyNeeded: getItInstance()));

  getItInstance.registerFactory<CompletedCubit>(
      () => CompletedCubit(getCompleted: getItInstance()));
  getItInstance
      .registerFactory<AllCubit>(() => AllCubit(getClones: getItInstance()));
}
