...
class GetNextVerifyNeeded extends Usecase<ClonesResultEntity, CloneIdParam> {
  final CloneRepository cloneRepository;
  GetNextVerifyNeeded(this.cloneRepository);

  @override
  Future<ClonesResultEntity> call(CloneIdParam params) async {
    return await cloneRepository.getNextVerifyNeededClones(params.cloneID);
  }
}
