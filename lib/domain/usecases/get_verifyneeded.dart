...
class GetVerifyNeeded extends Usecase<ClonesResultEntity, PageParam> {
  final CloneRepository cloneRepository;
  GetVerifyNeeded(this.cloneRepository);

  @override
  Future<ClonesResultEntity> call(PageParam params) async {
    return await cloneRepository.getVerifyNeededClones(params.page);
  }
}
